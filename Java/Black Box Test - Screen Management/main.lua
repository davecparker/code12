...
-- ct.setBackImage( String filename )
    ...
    this.colorNames = { "black", "white", "red", "green", "blue", "cyan", "majenta", "yellow", "gray", "orange", "pink", "purple", "light gray", "light red", "light green", "light blue", "light cyan", "light majenta", "light yellow", "dark gray", "dark red", "dark green", "dark blue", "dark cyan", "dark majenta", "dark yellow", length = 26, default = nil }
        ...
        if (screen == "1") then
            ...
            if not this.paused then
                ...
                elseif (this.updateCount - 1775) % 60 == 0 and this.colorsCount < this.colorNames.length then
                    ...
                    local colorName = ct.indexArray(this.colorNames, this.colorsCount)
    ...
    function _fn.onKeyPress(keyName)
        ...
        if (keyName == "space") or (keyName == "p") then
