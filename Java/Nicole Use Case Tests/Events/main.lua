...
-- Level 8. If-else   
    ...
    function start()
        ...
        this.majentaRect = ct.rect(spacing, spacing * 8 - offset, BOX_WIDTH, spacing, "dark majenta")
    ...
    function update()
        ...
        this.majentaRect.clickable = true
    ...
    function onMousePress(obj, x, y)
        ...
        if obj ~= nil then
            ...
            elseif obj == this.majentaRect then
                this.currentColor = "dark majenta"; 
    ...
    function onMouseDrag(obj, x, y)
        ...
        if ct.clickX() > this.palette.width + 1 then
            
            this.brush = ct.line(ct.clickX(), ct.clickY(), x + 2, y)
    ...
    function onMouseRelease(obj, x, y)
        ...
        if ct.clickX() > this.palette.width + 1 then
            this.brush = ct.line(x, y, ct.clickX(), ct.clickY()); end
    end
