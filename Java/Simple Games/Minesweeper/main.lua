...
require('Code12.api')
    ...
    function _fn.goodIndex(x, y)
        ...
        if x >= 0 and x < this.columns then
            
            if y >= 0 and y < this.rows then
    ...
    function _fn.start()
        ...
        this.smiley = ct.image("smiley.jpg", 50, 5, 10)
        local y = 0; while y < this.rows do
            
            local x = 0; while x < this.columns do
        ...
        while m < this.numbmines do
            ...
            local randX = ct.random(0, this.columns - 1)
            local randY = ct.random(0, this.rows - 1)
            --Checks if there is already a mine at this randomly selected coordinate
            local uniqueMine = true
            local newMineCord = (this.columns * randY) + randX
