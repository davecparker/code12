this = {}; _fn = {}   -- This file was generated by Code12 from "MathMiscTypeConversionTest.java"
...
-- import org.apache.commons.math3.special.Gamma;
    ...
    function _fn.runTests_roundDecimal(run)
        ...
        if run then
            ...
            _fn.testRoundDecimal(0.04, 1, 0.0)
            _fn.testRoundDecimal(-0.04, 1, 0.0)
            _fn.testRoundDecimal(-3.14, 1, -3.1)
            _fn.testRoundDecimal(-3.16, 1, -3.2)
            
            _fn.testRoundDecimal(123.4, 0, 123.0)
            _fn.testRoundDecimal(123.6, 0, 124.0)
            _fn.testRoundDecimal(-123.4, 0, -123.0)
            _fn.testRoundDecimal(-123.6, 0, -124.0)
    ...
    function _fn.runTests_toInt(run)
        ...
        if run then
            ...
            local i = 0; while i <= 1000 do
                ...
                _fn.testToInt(i, i)
                _fn.testToInt(i / 10.0, ct.intDiv(i, 10))
            i = i + 1; end
    ...
    function _fn.runTests_parseNumber(run)
        ...
        if run then
            ...
            _fn.testParseNumber(".123456", .123456)
            _fn.testParseNumber("+.123456", .123456)
            _fn.testParseNumber("-.123456", -.123456)
